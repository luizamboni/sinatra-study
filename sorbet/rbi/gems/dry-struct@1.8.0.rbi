...
class Dry::Struct
  ...
  #
  # source://dry-struct//lib/dry/struct.rb#123
  ...
  # @return [Struct]
  #
  # source://dry-struct//lib/dry/struct.rb#212
  ...
  # @return [Hash{Symbol => Object}]
  #
  # source://dry-struct//lib/dry/struct.rb#180
  def to_hash; end
  ...
  class << self
    ...
    # source://dry-struct//lib/dry/struct.rb#92
...
class Dry::Struct::Constructor < ::Dry::Types::Constructor
  # source://dry-struct//lib/dry/struct/constructor.rb#6
  def primitive; end
end
...
class Dry::Types::Printer
  # @api private
  #
  # source://dry-struct//lib/dry/struct/printer.rb#20

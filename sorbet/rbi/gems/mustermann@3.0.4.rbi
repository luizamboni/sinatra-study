...
class Mustermann::AST::Compiler < ::Mustermann::AST::Translator
  ...
  # source://mustermann//lib/mustermann/ast/compiler.rb#10
  def error_class; end
...
class Mustermann::AST::Expander < ::Mustermann::AST::Translator
  ...
  # source://mustermann//lib/mustermann/ast/expander.rb#13
  def error_class; end
...
class Mustermann::AST::Node::Capture < ::Mustermann::AST::Node
  ...
  # source://mustermann//lib/mustermann/ast/node.rb#116
  def name; end
...
class Mustermann::AST::Node::NamedSplat < ::Mustermann::AST::Node::Splat
  ...
  #
  # source://mustermann//lib/mustermann/ast/node.rb#198
  def name; end
end
...
class Mustermann::AST::Parser
  ...
  # source://mustermann//lib/mustermann/ast/parser.rb#46
...
class Mustermann::AST::Pattern < ::Mustermann::RegexpBased
  ...
  # source://mustermann//lib/mustermann/ast/pattern.rb#23
  ...
  # source://mustermann//lib/mustermann/ast/pattern.rb#24
  ...
  class << self
    ...
    # source://mustermann//lib/mustermann/ast/pattern.rb#22
...
class Mustermann::AST::Translator::NodeTranslator
  ...
  # source://mustermann//lib/mustermann/ast/translator.rb#49
  def node; end
...
class Mustermann::Expander
  ...
  #
  # source://mustermann//lib/mustermann/expander.rb#57
  def <<(*patterns); end
...
class Mustermann::Pattern
  ...
  #
  # source://mustermann//lib/mustermann/pattern.rb#319
  def &(other); end
  ...
  # @return [Mustermann::Pattern] a composite pattern
  #
  # source://mustermann//lib/mustermann/pattern.rb#320
  def ^(other); end
...
class Mustermann::RegexpBased < ::Mustermann::Pattern
  ...
  # source://mustermann//lib/mustermann/regexp_based.rb#40
  ...
  # @return [Regexp] regular expression equivalent to the pattern.
  #
  # source://mustermann//lib/mustermann/regexp_based.rb#12
  def to_regexp; end
